...
[Build Status]: https://github.com/ChimpsAtSea/Reach/actions/workflows/build.yml/badge.svg
[actions]: https://github.com/ChimpsAtSea/Reach/actions/workflows/build.yml
...
- Clone the repository:
  ...
  ```sh
  git clone https://github.com/ChimpsAtSea/Reach.git
  ```

- Copy your game's disc image to `orig/R42P69`.
