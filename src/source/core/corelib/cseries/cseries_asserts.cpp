...
// long register_tracked_assert(char const *, long);
// void log_tracked_assert(long);
// bool assert_handle(char const *, char const *, long);
// void assert_halt(void);
// bool assert_is_debugger_present(void);
// void assert_handle_slim_constant(struct s_slim_assert_info const *);
// void assert_handle_slim_dynamic(struct s_slim_assert_info const *, class c_assert_string const &);
